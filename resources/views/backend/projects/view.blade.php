         ...
         <div class="card card-header">
             <div class="row">
                 ...
                 <div class="col-md-6 float-left">
                    ...
                    @if ($project->status)
                        <button class="btn btn-danger btn-sm float-left"  onclick="handleUnPublish({{ $project->id }})"><span class="fa fa-send"></span> Inactive</button>
                    @else
                    <button class="btn btn-success btn-sm float-left" onclick="handlePublish({{ $project->id }})"><span class="fa fa-send"></span> Active</button>
                    @endif
...
function handlePublish(id) {
    ...
    form.action = '/admin/projects/Publish/' + id
    $('#publish').modal('show')
}
...
function handleUnPublish(id) {
    ...
    form.action = '/admin/projects/unPublish/' + id
