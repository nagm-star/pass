      ...
      <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center py-2">
        <div class="flex-grow-1">
          <h1 class="h3 fw-bold mb-2">
            ...
            <div class="">
                <a class="btn btn-success mt-2 mb-0" href="{{ route('admin.services.create') }}">
                  Add New Service  <i class="nav-main-link-icon si si-plus"></i>
                </a>
              </div>          
        </div>
      ...
      <div class="block-content block-content-full">
        ...
        <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
          ...
          <tbody>
            ...
            <tr>
              <td class="fw-semibold fs-sm">{!!  substr(strip_tags($service->title), 0, 50) !!}</td>
              <td class="d-none d-sm-table-cell fs-sm">
                {!!  substr(strip_tags($service->body), 0, 50) !!} 
              </td>
              @if ($service->category)
              <td class="d-none d-sm-table-cell fs-sm">
                    Sudanese Services
              ...
              <td class="text-left fs-sm">
                <a class="btn btn-sm btn-alt-secondary" href="{{ route('admin.services.show', $service->id) }}" data-bs-toggle="tooltip" title="View">
                  <i class="fa fa-fw fa-eye"></i>
                </a>
                <a class="btn btn-sm btn-alt-warning" href="{{ route('admin.services.edit', $service->id) }}" data-bs-toggle="tooltip" title="Edit">
                  <i class="fa fa-fw fa-pen text-warning"></i>
                </a>
                <a class="btn btn-sm btn-alt-danger" onclick="handleDelete({{ $service->id }})" data-bs-toggle="tooltip" title="Delete">
            ...
            <tr>
                <td colspan="4" class="d-none d-sm-table-cell fs-sm text-center">
                  <p calss="text-center">No services</p>
                </td>
