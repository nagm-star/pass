          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-left fs-sm">
                <a class="btn btn-sm btn-alt-success" onclick="handleRestore({{ $user->id }})" data-bs-toggle="tooltip" title="Restore">
            ...
            <tr>
                <td colspan="4" class="d-none d-sm-table-cell fs-sm text-center">
                  <p calss="text-center">No trashed users</p>
                </td>
...
<script>
  ...
  function handleRestore(id) {
     ...
     form.action = '/admin/user/restore/' + id
